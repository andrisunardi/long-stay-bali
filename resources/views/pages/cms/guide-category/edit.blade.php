...
use App\Livewire\Forms\CMS\GuideCategory\GuideCategoryEditForm;
use App\Models\GuideCategory;
use Illuminate\Validation\ValidationException;
use Livewire\Attributes\Title;

new #[Title('Edit | Guide Category')] class extends Component {
    public GuideCategory $guideCategory;

    public GuideCategoryEditForm $form;

    public function mount(GuideCategory $guideCategory): void
    {
        $this->guideCategory = $guideCategory;
        $this->form->set(guideCategory: $guideCategory);
    }

    public function resetForm(): void
    {
        $this->form->set(guideCategory: $this->guideCategory);
    }

    public function submit(): void
    {
        try {
            $this->form->submit(guideCategory: $this->guideCategory);

            session()->flash('success', [
                'title' => trans('index.edit') . ' ' . trans('index.success'),
                'message' => trans('page.guide_category') . ' ' . trans('message.has_been_successfully_edited'),
            ]);
...
<div class="container-fluid">
    <div class="card">
        ...
        <div class="card-body">
            <div class="row g-3">
                <div class="col-auto">
                    <a draggable="false" class="btn btn-success w-100" href="{{ route('cms.guide-category.index') }}"
                        wire:navigate>
            ...
            <form wire:submit.prevent="submit" role="form" autocomplete="off">
                <div class="row g-3">
                    ...
                    <div class="col-sm-6">
                        <label class="form-label" for="name_fr">
                            {{ trans('validation.attributes.name_fr') }}
                            <span class="text-danger">*</span>
                        </label>
                        <div class="input-group">
                            <div class="input-group-text">
