...
use App\Livewire\Forms\CMS\Guide\GuideEditForm;
...
new #[Title('Edit | Guide')] class extends Component {
    ...
    {
        $this->form->set(guide: $this->guide);
    }

    public function submit(): void
    {
        try {
            $this->form->submit(guide: $this->guide);

            session()->flash('success', [
                'title' => trans('index.edit') . ' ' . trans('index.success'),
                'message' => trans('page.guide') . ' ' . trans('message.has_been_successfully_edited'),
            ]);
...
<div class="container-fluid">
    <div class="card">
        ...
        <div class="card-body">
            <div class="row g-3">
                <div class="col-auto">
                    <a draggable="false" class="btn btn-success w-100" href="{{ route('cms.guide.index') }}" wire:navigate>
