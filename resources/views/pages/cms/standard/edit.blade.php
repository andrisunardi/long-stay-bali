...
use App\Livewire\Forms\CMS\Standard\StandardEditForm;
use App\Models\Standard;
use Illuminate\Validation\ValidationException;
use Livewire\Attributes\Title;

new #[Title('Edit | Standard')] class extends Component {
    public Standard $standard;

    public StandardEditForm $form;

    public function mount(Standard $standard): void
    {
        $this->standard = $standard;
        $this->form->set(standard: $standard);
    }

    public function resetForm(): void
    {
        $this->form->set(standard: $this->standard);
    }

    public function submit(): void
    {
        try {
            $this->form->submit(standard: $this->standard);

            session()->flash('success', [
                'title' => trans('index.edit') . ' ' . trans('index.success'),
                'message' => trans('page.standard') . ' ' . trans('message.has_been_successfully_edited'),
            ]);
...
<div class="container-fluid">
    <div class="card">
        ...
        <div class="card-body">
            <div class="row g-3">
                <div class="col-auto">
                    <a draggable="false" class="btn btn-success w-100" href="{{ route('cms.standard.index') }}"
                        wire:navigate>
