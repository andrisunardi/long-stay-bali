...
new #[Title('Detail | Property')] class extends Component {
    ...
    public function delete(): void
    {
        ...
        $service->delete(property: $this->property);
...
<div class="container-fluid">
        ...
        <div class="card-body">
            ...
            <div class="d-grid gap-3">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-7 col-md-8 col-lg-9 col-xl-10">
                        {{ $property->district->name ?? '-' }}, {{ $property->area->name ?? '-' }}
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-5 col-md-4 col-lg-3 col-xl-2">
                        <div class="fw-bold">{{ trans('property.electricity') }}</div>
                    </div>
                    <div class="col-sm-7 col-md-8 col-lg-9 col-xl-10">
                ...
                <h5 class="fw-bold text-uppercase border-bottom pb-3">
                    {{ trans('property.listing_information') }}
                </h5>

                <div class="row">
                    <div class="col-sm-5 col-md-4 col-lg-3 col-xl-2">
                        <div class="fw-bold">{{ trans('property.listing_type') }}</div>
                    </div>
                    <div class="col-sm-7 col-md-8 col-lg-9 col-xl-10">
                        {{ $property->listing_type ? Str::headline($property->listing_type->name) : '-' }}
                    </div>
                </div>

                <div class="row">
                    <div class="col-sm-5 col-md-4 col-lg-3 col-xl-2">
                        <div class="fw-bold">{{ trans('property.reference') }}</div>
                    </div>
                    <div class="col-sm-7 col-md-8 col-lg-9 col-xl-10">
                        {{ $property->reference ?? '-' }}
                    </div>
                ...
                <h5 class="fw-bold text-uppercase border-bottom pb-3">
                    {{ trans('property.sale_information') }}
                </h5>

                <div class="row">
                    <div class="col-sm-5 col-md-4 col-lg-3 col-xl-2">
                        <div class="fw-bold">{{ trans('property.sale_price') }}</div>
                    </div>
                    <div class="col-sm-7 col-md-8 col-lg-9 col-xl-10">
                        {{ Str::idr($property->sale_price) }}
                    </div>
                </div>

                <div class="row">
                    <div class="col-sm-5 col-md-4 col-lg-3 col-xl-2">
                        <div class="fw-bold">{{ trans('property.currency') }}</div>
                    </div>
                    <div class="col-sm-7 col-md-8 col-lg-9 col-xl-10">
                ...
                <div class="row">
                    <div class="col-sm-5 col-md-4 col-lg-3 col-xl-2">
                        <div class="fw-bold">{{ trans('property.ownership_type') }}</div>
                    </div>
                    <div class="col-sm-7 col-md-8 col-lg-9 col-xl-10">
                        {{ $property->ownership_type?->translate() ?? '-' }}
                    </div>
                </div>

                <div class="row">
                    <div class="col-sm-5 col-md-4 col-lg-3 col-xl-2">
                        <div class="fw-bold">{{ trans('property.lease_expiry_date') }}</div>
                    </div>
                    <div class="col-sm-7 col-md-8 col-lg-9 col-xl-10">
                        {{ $property->lease_expiry_date?->isoFormat('DD MMMM YYYY') ?? '-' }}
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-5 col-md-4 col-lg-3 col-xl-2">
                        <div class="fw-bold">{{ trans('property.lease_extension_available') }}</div>
                    </div>
                    <div class="col-sm-7 col-md-8 col-lg-9 col-xl-10">
                        {{ $property->lease_extension_available ? Str::headline($property->lease_extension_available->name) : '-' }}
                    </div>
                </div>

                <div class="row">
                    <div class="col-sm-5 col-md-4 col-lg-3 col-xl-2">
                        <div class="fw-bold">{{ trans('property.lease_extension_terms_or_price') }}</div>
                    </div>
                    <div class="col-sm-7 col-md-8 col-lg-9 col-xl-10">
                        {!! $property->lease_extension_terms_or_price ?? '-' !!}
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-5 col-md-4 col-lg-3 col-xl-2">
                        <div class="fw-bold">{{ trans('property.payment_plan_details') }}</div>
                    </div>
                    <div class="col-sm-7 col-md-8 col-lg-9 col-xl-10">
                ...
                <div class="row">
                    <div class="col-sm-5 col-md-4 col-lg-3 col-xl-2">
                        <div class="fw-bold">{{ trans('property.developer_name') }}</div>
                    </div>
                    <div class="col-sm-7 col-md-8 col-lg-9 col-xl-10">
    ...
    <livewire:activity-log :model="$property" />
</div>
