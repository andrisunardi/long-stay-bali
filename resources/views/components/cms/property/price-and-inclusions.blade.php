    ...
    <div class="col-sm-6">
        <div class="d-grid gap-3">
            <div>
                ...
                <div class="input-group">
                    ...
                    <input type="number" class="form-control" id="monthly_price" name="monthly_price" min="0"
                        max="100000000000" placeholder="{{ trans('index.ex') }}" required
                        wire:model="form.monthly_price" wire:offline.class="disabled" wire:offline.attr="disabled"
                ...
                <div class="col-auto">
                    ...
                    <div class="form-check form-switch">
                        <input class="form-check-input" type="checkbox" role="switch"
                            id="monthly_inclusions_housekeeper" name="monthly_inclusions_housekeeper" value="1"
                            {{ $form->monthly_inclusions['housekeeper'] ? 'checked' : '' }}
                            wire:model.lazy="form.monthly_inclusions.housekeeper" wire:offline.class="disabled"
                    ...
                    <div class="col">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" class="form-control"
                                ...
                                name="monthly_inclusions_housekeeper_frequency_per_week" min="1" max="255"
                                placeholder="{{ trans('index.ex') }} 4" required
            ...
            <div>
                ...
                <div class="form-check form-switch">
                    <input class="form-check-input" type="checkbox" role="switch" id="monthly_inclusions_gardener"
                        name="monthly_inclusions_gardener" value="1"
            ...
            <div>
                ...
                <div class="form-check form-switch">
                    <input class="form-check-input" type="checkbox" role="switch" id="monthly_inclusions_pool_guy"
                        name="monthly_inclusions_pool_guy" value="1"
            ...
            <div>
                ...
                <div class="form-check form-switch">
                    <input class="form-check-input" type="checkbox" role="switch" id="monthly_inclusions_internet"
                        name="monthly_inclusions_internet" value="1"
                        {{ $form->monthly_inclusions['internet'] ? 'checked' : '' }}
            ...
            <div>
                ...
                <div class="form-check form-switch">
                    <input class="form-check-input" type="checkbox" role="switch" id="monthly_inclusions_garbage"
                        name="monthly_inclusions_garbage" value="1"
            ...
            <div>
                ...
                <div class="form-check form-switch">
                    <input class="form-check-input" type="checkbox" role="switch" id="monthly_inclusions_banjar"
                        name="monthly_inclusions_banjar" value="1"
            ...
            <div>
                ...
                <div class="form-check form-switch">
                    <input class="form-check-input" type="checkbox" role="switch" id="monthly_inclusions_security"
                        name="monthly_inclusions_security" value="1"
                        {{ $form->monthly_inclusions['security'] ? 'checked' : '' }}
            ...
            <div>
                ...
                <div class="form-check form-switch">
                    <input class="form-check-input" type="checkbox" role="switch"
                        id="monthly_inclusions_electricity" name="monthly_inclusions_electricity" value="1"
                        {{ $form->monthly_inclusions['electricity'] ? 'checked' : '' }}
                        wire:model.lazy="form.monthly_inclusions.electricity" wire:offline.class="disabled"
                        wire:offline.attr="disabled" wire:loading.class="disabled" wire:loading.attr="disabled">
                    <label
        ...
        <div class="d-grid gap-3">
            <div>
                ...
                <div class="input-group">
                    ...
                    <input type="number" class="form-control" id="yearly_price" name="yearly_price" min="0"
                        max="100000000000" placeholder="{{ trans('index.ex') }}" required
                        wire:model="form.yearly_price" wire:offline.class="disabled" wire:offline.attr="disabled"
                        wire:loading.class="disabled" wire:loading.attr="disabled">
                </div>
                <div class="form-text">
                    {{ trans('helper.required') }},
            ...
            <div class="row">
                <div class="col-auto">
                    ...
                    <div class="form-check form-switch">
                        <input class="form-check-input" type="checkbox" role="switch"
                            id="yearly_inclusions_housekeeper" name="yearly_inclusions_housekeeper" value="1"
                            {{ $form->yearly_inclusions['housekeeper'] ? 'checked' : '' }}
                            wire:model.lazy="form.yearly_inclusions.housekeeper" wire:offline.class="disabled"
                            wire:offline.attr="disabled" wire:loading.class="disabled" wire:loading.attr="disabled">
                        <label
                    ...
                    <div class="col">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" class="form-control"
                                ...
                                name="yearly_inclusions_housekeeper_frequency_per_week" min="1" max="255"
                                placeholder="{{ trans('index.ex') }} 4" required
            ...
            <div>
                ...
                <div class="form-check form-switch">
                    <input class="form-check-input" type="checkbox" role="switch" id="yearly_inclusions_gardener"
                        name="yearly_inclusions_gardener" value="1"
            ...
            <div>
                ...
                <div class="form-check form-switch">
                    <input class="form-check-input" type="checkbox" role="switch" id="yearly_inclusions_pool_guy"
                        name="yearly_inclusions_pool_guy" value="1"
            ...
            <div>
                ...
                <div class="form-check form-switch">
                    <input class="form-check-input" type="checkbox" role="switch" id="yearly_inclusions_internet"
                        name="yearly_inclusions_internet" value="1"
            ...
            <div>
                ...
                <div class="form-check form-switch">
                    <input class="form-check-input" type="checkbox" role="switch" id="yearly_inclusions_garbage"
                        name="yearly_inclusions_garbage" value="1"
            ...
            <div>
                ...
                <div class="form-check form-switch">
                    <input class="form-check-input" type="checkbox" role="switch" id="yearly_inclusions_banjar"
                        name="yearly_inclusions_banjar" value="1"
            ...
            <div>
                ...
                <div class="form-check form-switch">
                    <input class="form-check-input" type="checkbox" role="switch" id="yearly_inclusions_security"
                        name="yearly_inclusions_security" value="1"
            ...
            <div>
                ...
                <div class="form-check form-switch">
                    <input class="form-check-input" type="checkbox" role="switch"
                        id="yearly_inclusions_electricity" name="yearly_inclusions_electricity" value="1"
                        {{ $form->yearly_inclusions['electricity'] ? 'checked' : '' }}
