<table>
    <thead>
        ...
        <tr>
            ...
            <th align="center"><b>{{ trans('field.slug') }}</b></th>
    ...
    <tbody>
        @forelse ($guides as $guide)
            <tr>
                ...
                <td align="center">{{ Str::yesNo($guide->is_active) }}</td>
                <td align="left">{{ $guide->slug }}</td>
                <td align="center">{{ $guide->counter }}</td>
                <td align="left">{{ $guide->createdBy?->name }}</td>
                <td align="left">{{ $guide->updatedBy?->name }}</td>
                <td align="left">{{ $guide->created_at }}</td>
                <td align="left">{{ $guide->updated_at }}</td>
            </tr>
        @empty
            <tr>
