...
'property.currency','property.operational_risk','property.operational_risk_level','property.comments_if_medium_or_high','property.final_decision',
'property.type','property.status','property.carpot','property.floors','service.title',
'service.description','service.our_services.title','service.our_services.description','service.our_services.request_a_service','service.our_standard.title',
'service.our_standard.description','service.cta.title','service.cta.description','service.cta.button_name','theme.theme',
'theme.light','theme.dark','theme.auto','validation.attributes.access_token','validation.attributes.address',
'validation.attributes.area_id','validation.attributes.area','validation.attributes.availability_date','validation.attributes.bedroom_1_has_natural_light','validation.attributes.bedroom_2_has_natural_light',
'validation.attributes.bedroom','validation.attributes.body_fr','validation.attributes.body_id','validation.attributes.body_zh','validation.attributes.body',
'validation.attributes.building_size','validation.attributes.code','validation.attributes.company','validation.attributes.confirm_reset','validation.attributes.created',
'validation.attributes.description_fr','validation.attributes.description_id','validation.attributes.description_zh','validation.attributes.description','validation.attributes.design_driven_property',
'validation.attributes.district_id','validation.attributes.electricity','validation.attributes.email','validation.attributes.end_date','validation.attributes.ensuite_bathrooms',
'validation.attributes.expires_in','validation.attributes.first_name','validation.attributes.full_legal_documentation','validation.attributes.fully_furnished','validation.attributes.guard_name',
'validation.attributes.guest_toilet','validation.attributes.guide_category_id','validation.attributes.icon','validation.attributes.image','validation.attributes.index',
'validation.attributes.internet_speedtest_image','validation.attributes.internet_speedtest','validation.attributes.is_active','validation.attributes.is_show','validation.attributes.land_size',
'validation.attributes.last_name','validation.attributes.latitude','validation.attributes.living_area_has_natural_light','validation.attributes.living_area','validation.attributes.living_style',
'validation.attributes.longitude','validation.attributes.message','validation.attributes.minimum_rental_duration_months','validation.attributes.name_fr','validation.attributes.name_id',
'validation.attributes.name_zh','validation.attributes.name','validation.attributes.no_festive_venue_nearby','validation.attributes.no_ongoing','validation.attributes.noise_source_identified',
...
'validation.attributes.view','validation.attributes.visit_date','validation.attributes.water_source','validation.attributes.when','validation.attributes.owner_id',
'validation.attributes.owner_name','validation.attributes.owner_phone','validation.attributes.owner_email','validation.attributes.owner_representative_id','validation.attributes.owner_representative_name',
'validation.attributes.owner_representative_phone','validation.attributes.owner_representative_email','validation.attributes.is_promoted','home.search.area_placeholder',);
