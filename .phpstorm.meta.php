...
'debugbar.options.db.explain.enabled','debugbar.options.db.only_slow_queries','debugbar.options.db.slow_threshold','debugbar.options.db.memory_usage','debugbar.options.db.soft_limit',
...
'index.bedroom','index.both','index.cancel','index.change_active','index.change_language',
'index.change_promoted','index.change_show','index.clear','index.close','index.connect',
'index.contact','index.currency','index.data','index.delete','index.detail',
'index.district','index.edit','index.enter_to_search','index.ex','index.export',
'index.failed','index.forgot_password','index.generate','index.hybrid','index.image_temporary_url',
'index.image','index.language','index.list_permission','index.list_role','index.list_user',
'index.list_your_property','index.login','index.logo','index.logout','index.message',
'index.monthly','index.navigation_menu','index.no','index.now','index.office_location',
'index.open','index.overview','index.printed_date','index.profile_menu','index.property_code',
'index.refresh','index.rental_type','index.reset_filter','index.reset','index.save',
'index.search_menu','index.search','index.select','index.solar','index.standard',
'index.submit','index.success','index.today','index.token','index.total',
'index.up','index.visit','index.yearly','index.yes','index.pdam',
'index.well','index.mixed','message.please_login_with_your_account_to_continue','message.please_enter_your_data_to_get_new_password','message.username_or_password_is_invalid',
...
'page.value','page.area','page.district','page.oauth','page.permission',
'page.role','page.user','page.profile','page.edit_profile','page.change_password',
'page.setting','page.activity','page.logout','pagination.showing','pagination.results',
'pagination.of','pagination.to','property.property_count','property.all_areas','property.property',
'property.per_month','property.per_year','property.inquiry_availability','property.months','property.location_property',
'property.description','property.property_only','property.more_images','property.whatsapp','property.email',
'property.property_details','property.availability','property.chat_for_check_availability_on_whatsapp','property.no_description_about_this_property','property.bedrooms',
'property.bathrooms','property.type_furnish','property.non_furnished','property.rental_type','property.minimum_rental_period',
'property.what_this_home_offers','property.monthly','property.yearly','property.weeks','property.property_identity',
'property.internal_property_code','property.availability_date','property.agent_name','property.date_of_visit','property.bedroom',
'property.location','property.villa_name','property.google_maps_url','property.gps_coordinates','property.address',
'property.district_or_area','property.size_and_surfaces','property.land_size','property.building_size','property.number_of_floors',
'property.outdoor_area_size','property.pool_size','property.bathrooms_and_layout','property.number_of_bathrooms','property.ensuite_bathrooms',
'property.guest_toilet','property.storage_or_staff_area','property.living_style','property.living_style_open','property.living_style_closed',
'property.living_style_mixed','property.legal_and_basic_eligibility','property.legal_documentation','property.full_legal_documentation_available','property.signed_listing_agreement',
'property.lease_agreement','property.land_certificate','property.owners_id','property.imb','property.pbg',
'property.slf','property.fully_furnished','property.rental_type_accepted','property.minimum_rental_duration','property.owner_price_flexibility',
...
'property.operational_risk','property.operational_risk_level','property.comments_if_medium_or_high','property.final_decision','property.status',
'property.carpot','property.floors','service.title','service.description','service.our_services.title',
'service.our_services.description','service.our_services.request_a_service','service.our_standard.title','service.our_standard.description','service.cta.title',
'service.cta.description','service.cta.button_name','theme.theme','theme.light','theme.dark',
'theme.auto','validation.attributes.access_token','validation.attributes.address','validation.attributes.area_id','validation.attributes.area',
'validation.attributes.availability_date','validation.attributes.bedroom_1_has_natural_light','validation.attributes.bedroom_2_has_natural_light','validation.attributes.bedroom','validation.attributes.body_fr',
'validation.attributes.body_id','validation.attributes.body_zh','validation.attributes.body','validation.attributes.building_size','validation.attributes.code',
'validation.attributes.company','validation.attributes.confirm_reset','validation.attributes.created','validation.attributes.description_fr','validation.attributes.description_id',
'validation.attributes.description_zh','validation.attributes.description','validation.attributes.design_driven_property','validation.attributes.district_id','validation.attributes.electricity',
'validation.attributes.email','validation.attributes.end_date','validation.attributes.ensuite_bathrooms','validation.attributes.expires_in','validation.attributes.first_name',
'validation.attributes.full_legal_documentation','validation.attributes.fully_furnished','validation.attributes.guard_name','validation.attributes.guest_toilet','validation.attributes.guide_category_id',
...
'validation.attributes.water_source','validation.attributes.when','validation.attributes.owner_id','validation.attributes.owner_name','validation.attributes.owner_phone',
'validation.attributes.owner_email','validation.attributes.owner_representative_id','validation.attributes.owner_representative_name','validation.attributes.owner_representative_phone','validation.attributes.owner_representative_email',
'validation.attributes.is_promoted','home.search.area_placeholder',);
