...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'social-medias.2.id' => 'integer',
            'social-medias.2.name' => 'string',
            'social-medias.2.icon' => 'string',
            'social-medias.2.username' => 'string',
            'social-medias.2.link' => 'string',
            'social-medias.3.id' => 'integer',
            'social-medias.3.name' => 'string',
            'social-medias.3.icon' => 'string',
            'social-medias.3.username' => 'string',
            'social-medias.3.link' => 'string',
...
'social-medias.1.icon','social-medias.1.username','social-medias.1.link','social-medias.2.id','social-medias.2.name',
'social-medias.2.icon','social-medias.2.username','social-medias.2.link','social-medias.3.id','social-medias.3.name',
'social-medias.3.icon','social-medias.3.username','social-medias.3.link','telescope.enabled','telescope.domain',
...
'04a4981dc875be0db2d9576a1a72dd7e::contact.info','04a4981dc875be0db2d9576a1a72dd7e::contact.maps','04a4981dc875be0db2d9576a1a72dd7e::form.trix','04a4981dc875be0db2d9576a1a72dd7e::home.coming-soon','04a4981dc875be0db2d9576a1a72dd7e::home.form',
'04a4981dc875be0db2d9576a1a72dd7e::home.guides','04a4981dc875be0db2d9576a1a72dd7e::home.hero','04a4981dc875be0db2d9576a1a72dd7e::home.our-services','04a4981dc875be0db2d9576a1a72dd7e::home.our-values','04a4981dc875be0db2d9576a1a72dd7e::home.select-locations',
'04a4981dc875be0db2d9576a1a72dd7e::layout.footer','04a4981dc875be0db2d9576a1a72dd7e::layout.header','04a4981dc875be0db2d9576a1a72dd7e::meta','04a4981dc875be0db2d9576a1a72dd7e::modal.search-menu','04a4981dc875be0db2d9576a1a72dd7e::navigation',
'04a4981dc875be0db2d9576a1a72dd7e::network','04a4981dc875be0db2d9576a1a72dd7e::pagination','04a4981dc875be0db2d9576a1a72dd7e::profile','04a4981dc875be0db2d9576a1a72dd7e::vendors','about.cta',
...
'af6a29d55d306249cfe5b80ece79872b::cms.value.detail','af6a29d55d306249cfe5b80ece79872b::cms.value.edit','af6a29d55d306249cfe5b80ece79872b::cms.value.index','af6a29d55d306249cfe5b80ece79872b::contact.index','af6a29d55d306249cfe5b80ece79872b::home.index',
...
'components.contact.header','components.contact.info','components.contact.maps','components.form.trix','components.home.coming-soon',
'components.home.form','components.home.guides','components.home.hero','components.home.our-services','components.home.our-values',
'components.home.select-locations','components.layout.footer','components.layout.header','components.meta','components.modal.search-menu',
'components.navigation','components.network','components.pagination','components.profile','components.vendors',
...
'excel.user','excel.value','f4ac99e09542ff494432bc959d4fee61::app','f4ac99e09542ff494432bc959d4fee61::breadcrumbs','f4ac99e09542ff494432bc959d4fee61::cms.error',
'f4ac99e09542ff494432bc959d4fee61::cms.footer','f4ac99e09542ff494432bc959d4fee61::cms.header','f4ac99e09542ff494432bc959d4fee61::error','f4ac99e09542ff494432bc959d4fee61::footer-v1','f4ac99e09542ff494432bc959d4fee61::status',
'form.trix','home.coming-soon','home.form','home.guides','home.hero',
'home.our-services','home.our-values','home.select-locations','layout.footer','layout.header',
'layouts.app','layouts.breadcrumbs','layouts.cms.error','layouts.cms.footer','layouts.cms.header',
'layouts.error','layouts.footer-v1','layouts.status','layouts::app','layouts::breadcrumbs',
'layouts::cms.error','layouts::cms.footer','layouts::cms.header','layouts::error','layouts::footer-v1',
...
'pages.contact.index','pages.home.index','pages.service.index','pages::about.index','pages::article.index',
...
'pages::cms.value.edit','pages::cms.value.index','pages::contact.index','pages::home.index','pages::service.index',
...
'profile','vendor.breadcrumbs.bootstrap4','vendor.breadcrumbs.bootstrap5','vendor.breadcrumbs.bulma','vendor.breadcrumbs.foundation6',
...
'contact.form.failed.title','contact.form.label.first_name','contact.form.label.last_name','contact.form.label.email','contact.form.label.phone',
'contact.form.label.area','contact.form.label.bedroom','contact.form.label.rental_type','contact.form.label.message','contact.form.placeholder.first_name',
'contact.form.placeholder.last_name','contact.form.placeholder.email','contact.form.placeholder.phone','contact.form.placeholder.bedroom','contact.form.placeholder.rental_type',
'contact.form.placeholder.message','contact.form.submit','field.#','field.access_token','field.action',
'field.active','field.address','field.agent','field.area_id','field.attribute',
'field.bedroom','field.code','field.company','field.confirm_password','field.confirm_reset',
'field.contact','field.created_at','field.created_by','field.created','field.date',
'field.description_id','field.description_zh','field.description','field.short_description_id','field.short_description_zh',
'field.short_description','field.district_id','field.email','field.end_date','field.expires_in',
'field.first_name','field.guard_name','field.icon','field.id','field.image_url',
'field.image','field.is_active','field.is_show','field.join_date','field.last_name',
'field.logo','field.message','field.name','field.new_password','field.password',
'field.permission_id','field.permission','field.permissions','field.phone','field.printed_at',
'field.property_id','field.refresh_token','field.remember_me','field.rental_type','field.role_id',
'field.role','field.roles','field.scope','field.search','field.show',
'field.start_date','field.status','field.title_id','field.title_zh','field.title',
'field.token_type','field.type','field.updated_at','field.updated_by','field.user_id',
'field.user','field.username','field.name_id','field.name_zh','field.guide_category_id',
'field.body','field.body_id','field.body_zh','field.slug','field.index',
...
'home.hero.description','home.form.title','home.form.button','home.form.area','home.form.when',
'home.form.bedroom','home.form.type','home.form.price_range','home.our_values.sub_title','home.our_values.title',
...
'home.guides.title','home.guides.description','home.guides.read_more','index.access','index.add',
...
'index.delete','index.detail','index.edit','index.enter_to_search','index.ex',
...
'index.success','index.today','index.token','index.total','index.visit',
'index.yes','index.up','index.index','message.please_login_with_your_account_to_continue','message.please_enter_your_data_to_get_new_password',
...
'pagination.of','pagination.to','property.property_identity','property.internal_property_code','property.availability_date',
