...
'home.guides.read_more','home.cta.title','home.cta.description','home.cta.button','index.access',
'index.add','index.all','index.area','index.availability','index.back_to',
'index.back','index.banner','index.bedroom','index.change_active','index.change_language',
'index.change_show','index.close','index.connect','index.contact','index.currency',
'index.data','index.delete','index.detail','index.edit','index.enter_to_search',
...
'index.visit','index.yes','index.up','index.district','index.index',
...
'pagination.showing','pagination.results','pagination.of','pagination.to','property.property',
'property.monthly_from','property.yearly_from','property.inquiry_availability','property.months','property.location_property',
