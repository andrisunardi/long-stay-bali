...
'database.redis.horizon.backoff_cap','database.redis.horizon.options.prefix','debugbar.enabled','debugbar.hide_empty_tabs','debugbar.except',
...
'debugbar.options.db.explain.enabled','debugbar.options.db.hints','debugbar.options.db.show_copy','debugbar.options.db.only_slow_queries','debugbar.options.db.slow_threshold',
...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./Users/andrisunardi/project/long-stay-bali/public/storage','flare.key',
...
'horizon.environments.production.supervisor-1.balanceCooldown','horizon.environments.local.supervisor-1.maxProcesses','ide-helper.filename','ide-helper.models_filename','ide-helper.meta_filename',
...
'ide-helper.enforce_nullable_relationships','ide-helper.post_migrate','ignition.editor','ignition.theme','ignition.enable_share_button',
...
'permission.cache.store','pretty-routes.url','pretty-routes.middlewares','pretty-routes.debug_only','pretty-routes.hide_methods',
...
'locale','home','storage.local',);
        registerArgumentsSet('views', 
'breadcrumbs::bootstrap4','breadcrumbs::bootstrap5','breadcrumbs::bulma','breadcrumbs::foundation6','breadcrumbs::materialize',
'breadcrumbs::tailwind','breadcrumbs::uikit','components.layouts.app','errors.401','errors.402',
'errors.403','errors.404','errors.419','errors.429','errors.500',
'errors.503','errors.layout','errors.minimal','livewire.home.index','livewire::bootstrap',
...
'vendor.pagination.simple-tailwind','vendor.pagination.tailwind','welcome','breadcrumbs::bootstrap4','breadcrumbs::bootstrap5',
