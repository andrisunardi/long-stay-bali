...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./Users/andrisunardi/project/long-stay-bali/public/storage',
...
'dompdf.options.font_height_ratio','dompdf.options.enable_html5_parser','livewire-alert.position','livewire-alert.timer','livewire-alert.toast',
...
'livewire-alert.showConfirmButton','livewire-alert.backdrop','horizon.name','horizon.domain','horizon.path',
...
'horizon.environments.local.supervisor-1.maxProcesses','telescope.enabled','telescope.domain','telescope.path','telescope.driver',
...
'breadcrumbs.manager-class','breadcrumbs.generator-class','tinker.commands','tinker.alias','tinker.dont_alias',);
...
'components.layouts.app','welcome','breadcrumbs::bootstrap4','breadcrumbs::bootstrap5','breadcrumbs::bulma',
