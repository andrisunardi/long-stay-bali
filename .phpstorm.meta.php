...
'constants.slack.channel','constants.color','database.default','database.connections.sqlite.driver','database.connections.sqlite.url',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./Users/andrisunardi/project/long-stay-bali/public/storage','flare.key','flare.flare_middleware',
...
'ide-helper.post_migrate','ignition.editor','ignition.theme','ignition.enable_share_button','ignition.register_commands',
...
'ignition.argument_reducers','laravel-webp.default_quality','laravel-webp.default_driver','laravel-webp.drivers.cwebp.path','laravel-webp.drivers.php-gd',
...
'telescope.watchers.Laravel\\Telescope\\Watchers\\ViewWatcher','tinker.commands','tinker.alias','tinker.dont_alias',);
...
'debugbar.cache.delete','debugbar.queries.explain','pretty-routes.show','horizon.stats.index','horizon.workload.index',
...
'locale','index','cms.login','storage.local',);
...
'components.layouts.pagination','components.layouts.vendors','errors.400','errors.401','errors.402',
...
'errors.maintenance','errors.minimal','livewire.cms.login.index','livewire.home.index','livewire::bootstrap',
...
'pagination::simple-bootstrap-5','pagination::simple-default','pagination::simple-tailwind','pagination::tailwind','vendor.breadcrumbs.bootstrap4',
...
'vendor.pagination.simple-tailwind','vendor.pagination.tailwind','vendors.autonumeric','vendors.bootstrap','vendors.canvas2image',
...
'vendors.sweetalert2','vendors.swiper','welcome','breadcrumbs::bootstrap4','breadcrumbs::bootstrap5',
...
'validation.custom.attribute-name.rule-name','field.username','field.password','field.remember_me','footer.copyright',
...
'greeting.good_night','index.logo','index.all','language.language','message.not_authorized_title',
'message.not_authorized_subtitle','message.not_authorized_description','message.you_have_already_registered','message.the_location_you_selected_is_out_of_quota','message.please_select_one_location',
'message.please_try_again_later','message.registration_has_been_canceled','message.re_registration_has_been_successfully','message.the_registration_fee_is_a_replacement_for_snacks_and_lunch','message.are_you_sure_to_cancel_this_registration',
'message.no_data_available','message.has_been_successfully_synced','message.has_been_successfully_export','page.home','page.login',
'page.forgot_password','page.permission','page.role','page.user','pagination.showing',
'pagination.to','pagination.total','pagination.data','theme.theme','theme.light',
'theme.dark','theme.auto','validation.attributes.name','validation.attributes.guard_name','validation.attributes.permission_ids',
'index.no_data_available','index.copyright','index.all_rights_reserved','page.location','page.registration',
'page.not_authorized','page.report',);
...
'MAIL_ENCRYPTION','MAIL_FROM_ADDRESS','MAIL_FROM_NAME','MAIL_MAILER','MAIL_SCHEME',
...
'AWS_USE_PATH_STYLE_ENDPOINT','VITE_APP_NAME','DEPLOY_SERVER','DEPLOY_DIRECTORY','DEPLOY_BRANCH',
'DEPLOY_RENDER','DEPLOY_SECRET','SLACK_SMS','SLACK_MAIL','SLACK_CHANNEL',
